            ...
            {user && (
              <nav className="hidden sm:ml-6 sm:flex sm:space-x-8">
                ...
                <Link
                  href="/calendar"
                  className={`inline-flex items-center px-1 pt-1 border-b-2 ${
                    isActive('/calendar') ? 'border-blue-500' : 'border-transparent'
                  } ${isActive('/calendar')} text-sm font-medium`}
                >
                  カレンダー
                </Link>
              </nav>
        ...
        {user ? (
          <div className="pt-2 pb-3 space-y-1">
            ...
            <Link
              href="/calendar"
              className={`block pl-3 pr-4 py-2 border-l-4 ${
                isActive('/calendar') ? 'border-blue-500 bg-blue-50' : 'border-transparent'
              } ${isActive('/calendar')} text-base font-medium`}
            >
              カレンダー
            </Link>
          </div>
